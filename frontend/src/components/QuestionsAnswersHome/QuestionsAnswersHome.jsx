...
import YesSvg from "../../utils/YesSvg";
const QuestionsAnswersHome = ({ landing }) => {
  ...
  const QAs = [
    {
      question: "PAGO SEGURO",
      answer:
        "Podes pagar con cualquier tarjeta a través de Hotmart! o transferencia por criptomonedas",
      answer_id: "1",
    },
    {
      question: "A INFORMACIÓN DE ENTREGA",
      answer:
        "Una vez confirmada la compra el producto te llegara en 3 minutos al email que ingreses. Aquí no hay envíos demorados ni productos que llegan en mal estado. Lo recibes al instante.",
      answer_id: "2",
    },
